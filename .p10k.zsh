# Generated by Powerlevel10k configuration wizard on 2025-08-19 at 18:07 SAST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_FOREGROUND=1
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEV_CONTENT_EXPANSION="$POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION"
  typeset -g POWERLEVEL9K_KUBECONTEXT_UAT_CONTENT_EXPANSION="$POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION"
